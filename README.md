...
For 32bit computers, use the following build:<br>
...
For 32bit streamers/computers, use the following build:<br>https://github.com/mbinnun/MBXUB/releases/download/V1.0/mbxub-tvstreamer-en-v1.0-32bit.iso
